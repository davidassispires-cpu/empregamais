...
function carregarPerguntasEliminatoriasEM(lista=[]){const box=document.getElementById('perguntasEliminatoriasLista');if(!box)return;box.innerHTML='';(Array.isArray(lista)?lista:[]).forEach(adicionarPerguntaEliminatoriaEM)}
