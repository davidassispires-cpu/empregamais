...
function salvarAvaliacaoProcessoEM(id){
 ...
 const get=k=>Number(document.getElementById('avp-'+k)?.value||0),criterios={comunicacao:get('comunicacao'),clareza:get('clareza'),organizacao:get('organizacao'),respeito:get('respeito'),feedback:get('feedback')};
