...
function cardVagaPortal(v){
 ...
 const logo=!v.confidencial&&(destaqueAtivo(v)||empresaAssinanteVaga(v))?(v.logo||v.logoUrl||v.empresaLogo||empLogoRecente.logo||empLogoRecente.logoUrl||empLogoRecente.perfil?.logo||''):'';
